        ...
        <Row>
          <CardGroup>
            <Card className="sombra mx-4 my-3" >
              ...
              <Card.Body>
                <Card.Title className="fonte_familia text-center text-uppercase">Aranhas</Card.Title>
            ...
            <Card className="sombra mx-4 my-3">
              <Card.Img variant="top" alt="formiga" className="m-0 p-0" src={formiga} />
              <Card.Body>
                <Card.Title className="fonte_familia text-center  text-uppercase">Formigas</Card.Title>
                <Card.Text className="text-justify fonte_familia">
            ...
            <Card className="sombra mx-4 my-3" >
              ...
              />
              <Card.Body>
                <Card.Title className="fonte_familia text-center  text-uppercase">Borboletas
                </Card.Title>
                <Card.Text className="text-justify fonte_familia">
